...
async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("cillsupport")
                await self.one.join_chat("stayheresay")
            except:
                pass
            assistants.append(1)
            try:
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("cillsupport")
                await self.two.join_chat("stayheresay")
            except:
                pass
            assistants.append(2)
            try:
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("cillsupport")
                await self.three.join_chat("stayheresay")
            except:
                pass
            assistants.append(3)
            try:
