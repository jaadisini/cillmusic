...
def first_page(_):
	controll_button = [InlineKeyboardButton(text=" ᴍᴇɴᴜ ", callback_data=f"settingsback_helper"), InlineKeyboardButton(text=" ɴᴇxᴛ ", callback_data=f"AuputSecpg")]
	first_page_menu = InlineKeyboardMarkup(
		[
			...
			[InlineKeyboardButton(text=_["H_B_7"], callback_data="help_callback hb7"), InlineKeyboardButton(text=_["H_B_8"], callback_data="help_callback hb8")],
			controll_button,
		]
	)
