...
BOT_TOKEN = getenv("BOT_TOKEN", "7250836835:AAFhaFNZiUFoImvU59_rENaFjyFyRoosNuI")
...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "Dza X Music" )

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1543559565").split())
...
SUPPORT_CHANNEL = getenv(
    "SUPPORT_CHANNEL", "https://t.me/zeropercentdza")
SUPPORT_GROUP = getenv(
    "SUPPORT_GROUP", "https://t.me/DzaSupport")
